...
8. Once it states that XinaA15 is "Currently in jailbreak state", make sure to install the Sileo: Xina Beta IPA's through TrollStore from here: [Sileo: Xina Beta](https://github.com/Sileo/Sileo/releases)
